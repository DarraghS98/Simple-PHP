...
insert into staff values
  ('SG14', 'David', 'Ford', '63 Ashby St, Patrick, Glasgow G11', '0141-339-2177', 
'Deputy', 'M', '1958-03-24', 18000, 'WL220658D', 'B3');
insert into staff values
  ('SA9', 'Mary', 'Howe', '2 Elm Pl, Aberdeen AB2 3SU', null, 'Assistant', 'F', 
'1970-02-19', 9000, 'WM532187D', 'B7');
insert into staff values
  ('SG5', 'Susan', 'Brand', '5 Gt Western Rd, Glasgow G12', '0141-334-2001', 
'Manager', 'F', '1940-06-03', 24000, 'WK588932E', 'B3');
insert into staff values
  ('SL41', 'Julie', 'Lee', '28 Malvern St, Kilburn NW2', '0181-554-3541', 
'Assistant', 'F', '1965-06-13', 9000, 'WA290573K', 'B5');
